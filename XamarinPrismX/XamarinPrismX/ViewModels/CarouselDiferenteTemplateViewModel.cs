...
{
    public class CarouselDiferenteTemplateViewModel : ViewModelBase
    {
        ...
        public CarouselDiferenteTemplateViewModel(INavigationService navigationService, IApiService apiService) : base(navigationService)
        {
